				...
				<%@ page import="com.example.demo.model.Review" %>
					...
					<%@ page import="com.example.demo.model.MathsClass" %>
						...
						<%@ page import="java.time.LocalDateTime" %>
							...
							<%@ page import="com.example.demo.model.PaidBookings" %>
									...
									<div class="wrapper">
										...
										<div id="sidebar">
											...
											<li class="dropdown active">
												...
												<li id="paid">
												    <a href="#" class="dashboard" onclick="showPaidBookingsPanel(); return false;">
												        <i class="material-icons">credit_card</i>Paid Bookings
												    </a>
												</li>
										...
										<div id="content">
											...
											<div class="top-navbar">
												<div class="xd-topbar">
													...
													<div class="xp-breadcrumbbar text-center">
														...
														<ol class="breadcrumb">
															<li class="breadcrumb-item"><a href="#paymentLink" class="btn btn-success" data-toggle="modal" style="color:white;" id="paymentButtonLink">Payment Link</a></li>
											...
											<div class="main-content">
												...
												<div class="row" id="tutorPanel">
																...
																<tbody>
																	...
																	<%      
																			...
																			<tr>
																				...
																				<a href="#documentsModal" class="documents" 
										    										data-toggle="modal" 
																					data-cvi='<%= tutor.getCv() != null ? Base64.getEncoder().encodeToString(tutor.getCv()) : "" %>'
																					data-educationi='<%= tutor.getEducation() != null ?  Base64.getEncoder().encodeToString(tutor.getEducation()) : "" %>'
																					data-idpassporti='<%= tutor.getIdPassport() != null ? Base64.getEncoder().encodeToString(tutor.getIdPassport()) : "" %>'
																					data-imagei='<%= tutor.getImage() != null ? Base64.getEncoder().encodeToString(tutor.getImage()) : "" %>'

																					>
																					
																					<i class="material-icons" data-toggle="tooltip" title="Document">&#xE2C7;</i>
																				</a>
																				...
																				<tr>
																					...
																					<% if (totalItemsLong > 0) { %>
																					    ...
																					    <div class="paginat">
																					        ...
																					        %>
																					                    <a href="/adminpage-<%= i %>" class="page-number"><%= i %></a>
																					        <%
																					                }
																					            }
																					        %>
													...
													<!--payment Link-->
													<div class="modal fade" tabindex="-1" id="paymentLink"
														role="dialog">
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<form action="/sendEmail" method="post">
																		...
																		<div class="mb-3">
																			<label>
																			    <input type="checkbox" name="clientSelf" value="yes" id="clientSelf" onchange="toggleStudentNameRequired()">
																			    Add Student Name?
																			</label>
																		...
																		<div class="grid-container">
																			<div class="mb-3">
																				...
																				<input type="text" id="lclient" name="lclient"
																					class="form-control"
																					placeholder="Sihle" required>
																			</div>

																			<div class="mb-3" id="notSelfAll">
																				<label for="name">Student Name</label>
																				<input type="text" id="lstudname"
																					name="lstudname" class="form-control"
																					placeholder="Yandisuthando">
																			</div>
																			
																			<div class="mb-3">
																				<label for="idnumber">Email</label>
																				<input type="email" id="lemail"
																					name="lemail" class="form-control"
																					required placeholder="sihle@esihleconnections.co.za">
																			</div>
																		
																			<div class="mb-3">
																				<label for="idnumber">Due date</label>
																				<input type="date" id="ldate"
																					name="ldate" class="form-control"
																					required>
																			</div>

																			<div class="mb-3">
																				<label for="idnumber">Amount</label>
																				<input type="text" id="lamount"
																					name="lamount" class="form-control"
																					required placeholder="1450">
																			</div>
																			
																			<div class="mb-3">
																				<label for="idnumber">Number of Sessions</label>
																				<input type="number" id="lsession"
																					name="lsession" class="form-control"
																					required placeholder="4">
																			</div>
																			
																			<div class="mb-3">
																				<label for="background">Tutoring Option</label>
																				<select id="ltutor"
																					name="ltutor"
																			...
																			<button type="submit" class="btn btn-success" onclick="validateLinksPay()">Send Email</button>
															...
															<div class="modal-content">
																<div class="modal-header">
																	...
																	<div class="modal-body">
																		<p>
																		<strong>CV: </strong>
																		<a href="#" id="cmodalCvLinkee" download class="green-link">download...</a>
																		</p>
																		<p>
																		<strong>Qualification: </strong>
																		<a href="#" id="cmodalEducationLinkee" download class="green-link">download...</a>
																		</p>
																		<p>
																		<strong>ID/Passport: </strong>
																		<a href="#" id="cmodalIdPassportLinkee" download class="green-link">download...</a>
																		<p>
																		<strong>Image: </strong>
																		<a href="#" id="cmodalImageLinkee" download class="green-link">download....</a>
																		</p>
														...
														<div class="table-wrapper">
															...
															<div class="table-title">
																<div class="row">
																	<div
																		class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
																		<h2 class="ml-lg-2">Paid Bookings</h2>
																	</div>
																</div>
															</div>
															...
															<table class="table table-striped table-hover">
																...
																<tbody>
																	...
																	<% List<PaidBookings> paidBookings = (List<PaidBookings>)
																			request.getAttribute("paid");
																			if (paidBookings != null && !paidBookings.isEmpty()) {

																			for (PaidBookings pb : paidBookings) {

																			String pcName = pb.getClientName();
																			String pcStudent = pb.getStudentName();
																			String pcEmail = pb.getEmail();
																			String pcAmount = pb.getAmount();
																			String pcSessions = pb.getNumSessions();
																			String pcTutoring = pb.getTutoringOption();
												...
												<div id="bookingModal" class="modal fade" tabindex="-1" role="dialog"
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																<form action="/delete-approved-booking" method="post">
																	<div class="modal-body">
																	<input type="hidden" name="deleteEmailApproved"
																		id="deleteEmailApproved" />
																	</div>
																	<div class="modal-footer">
																	<button type="button" class="btn btn-secondary"
																		data-dismiss="modal">Close</button>
																	<button type="submit" class="btn btn-danger"
																		onclick="confirmDeletionApproved()">Delete</button>
																	</div>
																</form>
															</div>
														</div>
												...
												<div id="registeredModal" class="modal fade" tabindex="-1" role="dialog"
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																<form action="/delete-registered-matric" method="post">
																	<div class="modal-body">
																		<input type="hidden" name="deleteMatricReg"
																			id="deleteMatricReg" />
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-secondary"
											...
											<script type="text/javascript">
												...
												$('a.documents').on('click', function () {
													// Get the email from the data attribute
											
													const cvBase64 = $(this).data('cvi');
													const educationBase64 = $(this).data('educationi');
													const idPassportBase64 = $(this).data('idpassporti');
													const imageBase64 = $(this).data('imagei');

													// Set CV link
													if (cvBase64) {
														$('#cmodalCvLinkee').attr('href', 'data:application/pdf;base64,' + cvBase64);
													} else {
														$('#cmodalCvLinkee').attr('href', '#').text(' not uploaded');
													}

													// Set Education link
													if (educationBase64) {
														$('#cmodalEducationLinkee').attr('href', 'data:application/pdf;base64,' + educationBase64);
													} else {
														$('#cmodalEducationLinkee').attr('href', '#').text(' not uploaded');
													}

													// Set ID Passport link
													if (idPassportBase64) {
														$('#cmodalIdPassportLinkee').attr('href', 'data:application/pdf;base64,' + idPassportBase64);
													} else {
														$('#cmodalIdPassportLinkee').attr('href', '#').text(' not uploaded');
													}

													// Set Image link
													if (imageBase64) {
														$('#cmodalImageLinkee').attr('href', 'data:image/jpeg;base64,' + imageBase64);
													} else {
														$('#cmodalImageLinkee').attr('href', '#').text(' not uploaded');
													}
												...
												$(document).ready(function () {
													$('a.registeredView').on('click', function () {
													   ...
													   var checkStatusR = "matricViewR"+statusIdSend;
														...
														var deleteMatricReg = document.getElementById('deleteMatricReg');
														deleteMatricReg.value = statusIdSend;
														deleteMatricReg.placeholder = statusIdSend;
												...
												$(document).ready(function () {
													...
													$('a.otherView').on('click', function () {
														...
														var deleteEmailOth = document.getElementById('deleteEmailOther');
														deleteEmailOth.value = cIs;
														deleteEmailOth.placeholder = cIs;
												...
												$(document).ready(function () {
													...
													$('.view').on('click', function () {
														...
														var deleteEmailOther = document.getElementById('deleteEmailApproved');
														deleteEmailOther.value = aID;
														deleteEmailOther.placeholder = aID;
												...
												function showTutorPanel() {
													...
													document.getElementById('paymentButtonLink').style.display = 'block';
												...
												document.getElementById('consultMathsRegisteredPanel').style.display="none";
												document.getElementById('paidPanel').style.display = 'none';
												document.getElementById('paymentButtonLink').style.display = 'none';
												...
												function showPaidBookingsPanel() {
											...
											function showConsultMatricPanel(){
												...
												function confirmDeletionApproved() {
												...
												const notSelf = document.getElementById('notSelfAll');
												notSelf.style.display = 'none';
												
												const selfPayment = document.getElementById('clientSelf');
												

												selfPayment.addEventListener('change', function () {
													if (this.checked) {
														notSelf.style.display = 'block';
													} else {
														notSelf.style.display = 'none';
													}
												});
												
												function toggleStudentNameRequired() {
												    var studentNameField = document.getElementById('lstudname');
												    var checkbox = document.getElementById('clientSelf');
											...
											function validateLinksPay() {
											    // Get the values of all the fields
											    var clientName = document.getElementById('lclient').value;
											    var studentName = document.getElementById('lstudname').value;
											    var email = document.getElementById('lemail').value;
											    var dueDate = document.getElementById('ldate').value;
											    var amount = document.getElementById('lamount').value;
											    var sessions = document.getElementById('lsession').value;
											    var tutorOption = document.getElementById('ltutor').value;
												...
												if (checkbox.checked) {
													...
													if (clientName !== "" && studentName !== "" && email !== "" && dueDate !== "" && amount !== "" && sessions !== "" && tutorOption !== "") {
													    // If all fields are filled, show the alert
													    alert("An email with payment link has been sent to the client, check emails in sent folder.");
													} 
												    
												} else {
												    
													if (clientName !== "" && email !== "" && dueDate !== "" && amount !== "" && sessions !== "" && tutorOption !== "") {
													    // If all fields are filled, show the alert
													    alert("An email with payment link has been sent to the client, check emails in sent folder.");
													} 
